...
-- Check if the player's User ID is in the allowed list
...
-- If the player is authorized
if checkAuthorization() then
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Succesfully Authorized",
    ...
    -- Authorized: Continue with the script

    -- Start by loading the Fluent UI Library
    ...
    -- Toggle Behavior for Pet Manager
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        ...
        Text = "You dont have permission to use this Script",
        Duration = 5,
        Button1Callback = function()
            print("User acknowledged the notification")
        end,
    ...
    -- If not authorized, show a warning and stop the script execution
