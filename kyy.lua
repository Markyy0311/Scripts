...
OpFarmSection:AddToggle("FastRebirth", {
    ...
    Callback = function(value)
        ...
        Library:Notify{
            Title = "Fast Rebirth",
            Content = "Fast Rebirth Status: Running",
            SubContent = tostring(value),
            Duration = 3
        }
    end
})
...
local repsPerTick = 20 -- fixed 20 reps
...
OpFarmSection:AddToggle("FastRep", {
    Title = "Fast Strength",
    Default = false,
    Callback = function(value)
        runFastRep = value
        ...
        Library:Notify{
            Title = "Fast Rep",
            Content = "Fast Strength Status: Running",
            SubContent = tostring(value),
            Duration = 3
        }
    end
...
-- Ultimates section
local UltSection = Tab:AddSection("Auto Buy Ultimates")
...
local TabTeleport = Window:AddTab{
    Title = "Teleport",
    Icon = "map-pin"  -- lucide-locate
}

local function tp(cf, msg)
    local player = game.Players.LocalPlayer
...
TabTeleport:AddButton({
    Title = "Spawn",
    Callback = function()
        tp(CFrame.new(2, 8, 115), "Teleported to Spawn")
    end
})
...
TabTeleport:AddButton({
    Title = "Secret Area",
    Callback = function()
        tp(CFrame.new(1947, 2, 6191), "Teleported to Secret Area")
    end
})
...
TabTeleport:AddButton({
    Title = "Tiny Island",
    Callback = function()
        tp(CFrame.new(-34, 7, 1903), "Teleported to Tiny Island")
    end
})
...
TabTeleport:AddButton({
    Title = "Mythical",
    Callback = function()
        tp(CFrame.new(2255, 7, 1071), "Teleported to Mythical Area")
    end
})
...
TabTeleport:AddButton({
    Title = "Inferno",
    Callback = function()
        tp(CFrame.new(-6768, 7, -1287), "Teleported to Inferno")
    end
})
...
TabTeleport:AddButton({
    Title = "Legend Gym",
    Callback = function()
        tp(CFrame.new(4604, 991, -3887), "Teleported to Legend Zone")
    end
})
...
TabTeleport:AddButton({
    ...
    Callback = function()
        tp(CFrame.new(-8646, 17, -5738), "Teleported to Muscle King Gym")
    end
})
...
TabTeleport:AddButton({
    Title = "Jungle",
    Callback = function()
        tp(CFrame.new(-8659, 6, 2384), "Teleported to Jungle")
    end
})
...
TabTeleport:AddButton({
    Title = "Brawl Lava",
    Callback = function()
        tp(CFrame.new(4471, 119, -8836), "Teleported to Lava Brawl")
    end
})
...
TabTeleport:AddButton({
    Title = "Brawl Desert",
    Callback = function()
        tp(CFrame.new(960, 17, -7398), "Teleported to Desert Brawl")
    end
})
...
TabTeleport:AddButton({
    Title = "Brawl Regular",
    Callback = function()
        tp(CFrame.new(-1849, 20, -6335), "Teleported to Beach Brawl")
    end
})
